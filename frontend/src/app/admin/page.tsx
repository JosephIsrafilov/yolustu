            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-2">
                  {Array.from({ length: 3 }).map((_, i) => (
                    <div key={i} className="rounded-xl border border-border p-2">
                      <Skeleton className="h-6 w-16 rounded-full mx-auto mb-1" />
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-4 gap-1.5">
                  {Array.from({ length: 4 }).map((_, i) => (
                    <div key={i} className="rounded-xl border border-border p-1.5">
                      <Skeleton className="h-5 w-12 rounded-full mx-auto mb-1" />

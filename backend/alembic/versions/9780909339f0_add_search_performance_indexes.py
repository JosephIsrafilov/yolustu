...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_rides_destination_city", "rides", ["destination_city"], unique=False
    )

    # Rides - composite index for common search patterns
    op.create_index(
        "ix_rides_status_departure", "rides", ["status", "departure_time"], unique=False
    )

    # Rides - available seats filtering
    op.create_index(
        "ix_rides_available_seats", "rides", ["available_seats"], unique=False
    )
    ...
    op.create_index(
        "ix_users_verification_status", "users", ["verification_status"], unique=False
    )
    ...
    op.create_index(
        "ix_payments_passenger_id", "payments", ["passenger_id"], unique=False
    )
    ...
    op.create_index(
        "ix_wallet_transactions_type", "wallet_transactions", ["type"], unique=False
    )
    op.create_index(
        "ix_wallet_transactions_status", "wallet_transactions", ["status"], unique=False
    )
    ...
    op.create_index(
        "ix_user_badges_badge_id", "user_badges", ["badge_id"], unique=False
    )

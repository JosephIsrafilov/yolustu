...
RIDE_STATUSES = {RIDE_ACTIVE, RIDE_BOARDING, RIDE_CANCELLED, RIDE_COMPLETED}
BOOKING_STATUSES = {
    BOOKING_PENDING,
    BOOKING_ACCEPTED,
    BOOKING_PAID,
...
_RIDE_TRANSITIONS = {
    RIDE_ACTIVE: {RIDE_BOARDING, RIDE_CANCELLED, RIDE_COMPLETED},
    RIDE_BOARDING: {RIDE_CANCELLED, RIDE_COMPLETED},
    RIDE_CANCELLED: set(),
    RIDE_COMPLETED: set(),
}
...
_BOOKING_TRANSITIONS = {
    ...
    BOOKING_BOARDED: {BOOKING_COMPLETED, BOOKING_NO_SHOW},
    BOOKING_NO_SHOW: {BOOKING_BOARDED},

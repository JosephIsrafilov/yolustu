...
Index("ix_conversations_created_by_user_id", Conversation.created_by_user_id)
...
Index("ix_messages_ride_id", Message.ride_id)
Index("ix_reviews_target_id", Review.target_id)
Index("ix_reviews_author_id", Review.author_id)
Index("ix_reviews_ride_id", Review.ride_id)

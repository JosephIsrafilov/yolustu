...
def seed_db():
    ...
    try:
        ...
        vehicles_data = [
            {"id": "v1", "user_id": "u1", "brand": "Toyota", "model": "Prius", "year": 2015, "color": "White", "plate_number": "99-XX-001"},
            {"id": "v2", "user_id": "u3", "brand": "Hyundai", "model": "Elantra", "year": 2018, "color": "Silver", "plate_number": "77-YY-777"},
            {"id": "v3", "user_id": "u5", "brand": "Kia", "model": "Rio", "year": 2017, "color": "Blue", "plate_number": "10-ZZ-101"},
        ]

        vehicle_map = {}
        for v_data in vehicles_data:
            owner = user_map[v_data["user_id"]]
            vehicle = db.query(Vehicle).filter(Vehicle.plate_number == v_data["plate_number"]).first()
            if not vehicle:
                vehicle = Vehicle(
                    id=uuid.uuid4(),
                    user_id=owner.id,
        ...
        rides_data = [
            {
                "id": "t1", "driver_id": "u1", "vehicle_id": "v1", 
                "origin": "Bakı", "dest": "Gəncə", "price": 15, "seats": 3,
                "origin_coords": "POINT(49.8671 40.4093)", "dest_coords": "POINT(46.3606 40.6828)"
            },
            {
                "id": "t2", "driver_id": "u3", "vehicle_id": "v2", 
                "origin": "Bakı", "dest": "Quba", "price": 10, "seats": 4,
                "origin_coords": "POINT(49.8671 40.4093)", "dest_coords": "POINT(48.5134 41.3643)"
            },
            {
                "id": "t3", "driver_id": "u5", "vehicle_id": "v3", 
                "origin": "Sumqayıt", "dest": "Bakı", "price": 8, "seats": 3,
                "origin_coords": "POINT(49.6667 40.5897)", "dest_coords": "POINT(49.8671 40.4093)"
            }
        ]
